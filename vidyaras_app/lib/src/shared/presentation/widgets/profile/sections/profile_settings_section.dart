...
/// Contains account, notifications, language, privacy, and help options
class ProfileSettingsSection extends StatelessWidget {
          ...
          child: Column(
            children: [
              ProfileListTile(
                ...
                onTap: onAccountSettingsTap ?? () => _showComingSoon(context, 'Account Settings'),
              ),
              ProfileListTile(
                ...
                onTap: onNotificationsTap ?? () => _showComingSoon(context, 'Notifications'),
              ),
              ProfileListTile(
                icon: Icons.language,
                title: 'Language',
                ...
                onTap: onLanguageTap ?? () => _showComingSoon(context, 'Language Settings'),
              ),
              ProfileListTile(
                ...
                onTap: onPrivacyTap ?? () => _showComingSoon(context, 'Privacy & Security'),
              ),
              ProfileListTile(
  ...
  void _handleHelpSupport(BuildContext context) async {
    final Uri emailUri = Uri(
      ...
      queryParameters: {
        'subject': 'VidyaRas Support Request',
      },
    );
