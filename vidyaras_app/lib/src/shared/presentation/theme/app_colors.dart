...
class AppColors {
  ...
  // Gradient Colors
  static const Color gradientStart = Color(0xFF4F87FF); // Blue
  static const Color gradientMiddle = Color(0xFF7B68EE); // Blue-Purple
  static const Color gradientEnd = Color(0xFF9C4DFF); // Purple
  ...
  static const Color music = Color(0xFF6366F1); // Blue-Indigo
  static const Color wellness = Color(0xFFFBBF24); // Yellow
  static const Color yoga = Color(0xFF8B5CF6); // Purple
  static const Color artsDance = Color(0xFFEF4444); // Red
  static const Color lifeSkills = Color(0xFFF59E0B); // Amber

  // Referral Card Colors
